	...
	<body>
		<header id="barra">
		  <div class="container">
		      ...
		      <ul>
				...
				<li><a href="crearCurso.php" class="active">Crear Horarios</a></li>
		...
		<div class="container">
	        <div class="row">
	            ...
	            <div class="col-sm-6">
	                <h1 class="mb-5 mt-5 text-center">Crea un horario</h1>
	                <form action="../c/CrearHorario.php" novalidate="" method="post">
	                    <div class="row g-3">
